                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-c1 border border-c8/[.2] rounded-2xl px-3 py-2 focus:outline-none focus:ring focus:border-blue-300"
                        />
                    </div>
                    <div>
                        <label className="block font-semibold mb-2 text-left">
                        ...
                        <textarea
                            ...
                            required
                            className="w-full px-3 py-2 bg-c1 border border-c8/[.2] rounded-2xl focus:outline-none focus:ring focus:border-blue-300 h-48"
                        />
                    </div>
                    <div>
                        <label className="block font-semibold mb-2 text-left">
                        ...
                        <div className="tablet:hidden">
                            ...
                            <div className="flex mt-2 mx-2">
                                <input
                                    ...
                                    onKeyDown={handleTagInputKeyDown}
                                    placeholder="Add up to 5 tags to describe what your question is about"
                                    className="flex-grow px-3 py-2 bg-c1 border border-c8/[.2] rounded-2xl focus:outline-none"
                                />
                            </div>
                        </div>
