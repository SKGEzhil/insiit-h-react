...
function QuestionPage() {
    ...
    // Function to generate meta description from question content
    ...
    return (
        question ? (
            <>
                <Helmet>
                    <title>{`${question.title} | InsIIT`}</title>
                    <meta name="description" content={generateMetaDescription(question.body)} />
                    <meta name="keywords" content={question.tags?.join(', ') || ''} />
                    <link rel="canonical" href={`https://insiit.in/question/${id}`} />
                    {/* Open Graph Meta Tags */}
                    <meta property="og:title" content={question.title} />
                    <meta property="og:description" content={generateMetaDescription(question.body)} />
                    <meta property="og:type" content="article" />
                    <meta property="og:url" content={`https://insiit.in/question/${id}`} />
                    {/* Twitter Card Meta Tags */}
                    <meta name="twitter:card" content="summary" />
                    <meta name="twitter:title" content={question.title} />
                    <meta name="twitter:description" content={generateMetaDescription(question.body)} />
                    {/* Additional Meta Tags */}
                    <meta name="author" content={question.author?.name || 'InsIIT'} />
                    ...
                    <script type="application/ld+json">{JSON.stringify({
                        ...
                        "upvoteCount": question.votes?.votes || 0,
            ...
            <>
                <Helmet>
                    <title>Loading Question | InsIIT</title>
